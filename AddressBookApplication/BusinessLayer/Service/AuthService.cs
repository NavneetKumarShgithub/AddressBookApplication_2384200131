...
namespace BusinessLayer.Service
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(AddressBookContext context, IMapper mapper, IConfiguration configuration, RabbitMQService rabbitMQService)
        {
        ...
        public async Task<string> Register(UserDTO userDTO)
        {
            ...
            var message = $"New user registered: {user.Email}";
