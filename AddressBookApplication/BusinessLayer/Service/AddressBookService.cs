...
namespace BusinessLayer.Service
{
    public class AddressBookService : IAddressBookService
    {
        ...
        public AddressBookService(AddressBookContext context, IMapper mapper, RedisCacheService cacheService, RabbitMQService rabbitMQService)
        {
            _context = context;
        ...
        public async Task<AddressBookDTO> AddContact(AddressBookDTO contactDTO)
        {
            ...
            var message = $"New contact added: {contactDTO.Name} - {contactDTO.Email}";
            _rabbitMQService.PublishMessage($"New contact added: {contactDTO.Name}");
